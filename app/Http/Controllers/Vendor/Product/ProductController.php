...
class ProductController extends BaseController
{
    ...
    public function getUpdateView(string|int $id): RedirectResponse|View
    {
        ...
        return view(Product::UPDATE[VIEW], compact('product','ingredients','categories', 'brands', 'brandSetting', 'digitalProductSetting', 'colors', 'attributes', 'languages', 'defaultLanguage', 'digitalProductFileTypes'));
    }
